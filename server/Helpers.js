...
const createNewUserSignUp = (first_name,last_name,email,password,organization,rank) => {
...
const createNewUserAdmin = (first_name, last_name, email, password, organization_id, rank) => {
...
module.exports = {createNewUserSignUp, createNewUserAdmin, updateMember, createNewMeasurement, patchKeyResult, persPatchKeyResult, createNewPersMeasurement}